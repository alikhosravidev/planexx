                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <x-panel::ui.table.head>
                                <x-panel::ui.table.th>نام دپارتمان</x-panel::ui.table.th>
                                <x-panel::ui.table.th>کد</x-panel::ui.table.th>
                                <x-panel::ui.table.th>نوع</x-panel::ui.table.th>
                                <x-panel::ui.table.th>مدیر</x-panel::ui.table.th>
                                <x-panel::ui.table.th>تعداد کارمندان</x-panel::ui.table.th>
                                <x-panel::ui.table.th>وضعیت</x-panel::ui.table.th>
                                <x-panel::ui.table.th align="center">عملیات</x-panel::ui.table.th>
                            </x-panel::ui.table.head>

                            <x-panel::ui.table.body>
                                @forelse($departments as $dept)
                                    @include('panel::departments.partials.department-row', ['dept' => $dept, 'level' => 0])
                                @empty
                                    <x-panel::ui.table.empty :colspan="7" icon="fa-building" message="دپارتمانی یافت نشد" />
                                @endforelse
                            </x-panel::ui.table.body>
                        </table>
                    </div>
