        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <button type="button" onclick="toggleModulePermissions('{{ $module['id'] ?? '' }}', true)"
                        class="text-xs text-text-secondary hover:text-primary transition-colors duration-200">انتخاب همه
                </button>
                <span class="text-border-medium">|</span>
                <button type="button" onclick="toggleModulePermissions('{{ $module['id'] ?? '' }}', false)"
                        class="text-xs text-text-secondary hover:text-red-600 transition-colors duration-200">حذف انتخاب
                </button>
                    ...
                    <tr class="border-b border-border-light last:border-0 hover:bg-bg-secondary/50 transition-colors duration-200">
                        ...
                        @foreach($standardPermissions as $permKey => $perm)
                            @php
                                ...
                                $checked = in_array($permissionName, $rolePermissions ?? []);
                            @endphp
                        ...
                        <td class="px-3 py-4 text-center">
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <button type="button" onclick="toggleEntityPermissions('{{ ($module['id'] ?? '') . '_' . ($entity['id'] ?? '') }}', false)"
                                        class="w-7 ه-7 flex items-center justify-center text-text-muted hover:text-red-600 hover:bg-red-50 rounded transition-all duration-200"
                                        title="حذف انتخاب">
