...
$imageService = AIImageServiceFactory::createWithOpenAI('your-api-key-here');
...
$imageService = AIImageServiceFactory::createFromEnv();
...
$imageService = AIImageServiceFactory::createWithMultipleProviders([
    [
        'type' => 'openai',
