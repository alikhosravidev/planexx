...
$geminiService = ImageServiceFactory::createWithGemini('YOUR_GEMINI_API_KEY');
...
$seedreamService = ImageServiceFactory::createWithSeedream('YOUR_SEEDREAM_API_KEY');
...
$multiProviderService = ImageServiceFactory::createWithMultipleProviders([
    [
        'type' => 'openai',
...
$envService = ImageServiceFactory::createFromEnv();
