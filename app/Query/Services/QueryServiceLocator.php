...
use App\Query\Exceptions\ServiceResolutionException;
...
class QueryServiceLocator
{
    ...
    public function register(string $contextName, string $serviceInterface): void
    {
        ...
        if (! is_subclass_of($serviceInterface, QueryServiceInterface::class)) {
            throw new ServiceResolutionException(
    ...
    public function resolve(string $contextName): QueryServiceInterface
    {
