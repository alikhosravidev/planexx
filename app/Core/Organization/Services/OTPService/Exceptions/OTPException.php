...
class OTPException extends BusinessException
{
    ...
    {
        return new self(trans('Organization::errors.invalid_otp_code'));
    }

    public static function invalidChannel(): self
    {
        return new static(
            trans('Organization::errors.no_valid_channel')
        );
    }
    ...
    {
        return new self(
            trans('Organization::errors.otp_sending_failed')
        );
    }
    ...
    {
        return new self(
            trans('Organization::errors.otp_identifier_invalid')
        );
    }
}
