...
class StoreUserRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'mobile'            => ['required', 'string', 'mobile', Rule::unique(User::class, 'mobile')],
            'email'             => ['nullable', 'email', 'email', Rule::unique(User::class, 'email')],
            'national_code'     => ['nullable', 'digits:10', Rule::unique(User::class, 'national_code')],
