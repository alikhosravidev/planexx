...
use App\Core\FileManager\Http\Controllers\API\V1\Admin\FavoriteAPIController;
use App\Core\FileManager\Http\Controllers\API\V1\Admin\FileAPIController;
use App\Core\FileManager\Http\Controllers\API\V1\Admin\FolderAPIController;
