    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 flex flex-col min-w-0">
            ...
            <div class="flex-1 p-6 lg:p-8">
                @if (isset($favoriteFolders) && count($favoriteFolders) > 0)
                    <div class="mb-8">
                        <div class="flex items-center justify-between mb-4">
                            <h2 class="text-lg font-semibold text-text-primary">پوشه‌های علاقه‌مند</h2>
                        </div>
                ...
                <div class="bg-bg-primary border border-border-light rounded-2xl overflow-hidden">
                    <div class="px-6 py-4 border-b border-border-light flex items-center justify-between">
                        <h2 class="text-lg font-semibold text-text-primary">فایل‌های علاقه‌مند</h2>
                        <div class="text-sm text-text-muted">
                            {{ $stats['total_files'] ?? 0 }} فایل
                        </div>
                    </div>
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-end gap-1">
                                                <button
                                                    ...
                                                    class="w-8 h-8 flex items-center justify-center rounded-lg transition-all duration-200 text-amber-500 hover:bg-amber-50"
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center justify-center">
                                                <i class="fa-solid fa-star text-6xl text-text-muted/30 mb-4"></i>
                                                <p class="text-text-muted">هیچ فایل علاقه‌مندی وجود ندارد</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
