                                    ...
                                    <tr class="hover:bg-bg-secondary/50 transition-colors duration-200" data-file-id="{{ $file['id'] }}">
                                        <td class="px-6 py-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div class="min-w-0">
                                                    <span class="text-sm font-medium text-text-primary truncate leading-tight block">{{ $file['title'] ?? $file['original_name'] }}</span>
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center justify-center">
                                                <i class="fa-solid fa-hourglass-half text-6xl text-text-muted/30 mb-4"></i>
                                                <p class="text-text-muted">هیچ فایل موقتی وجود ندارد</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
