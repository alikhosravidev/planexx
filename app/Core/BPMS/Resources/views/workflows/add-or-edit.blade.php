...
<x-layouts.app :title="$pageTitle">
                ...
                <form data-ajax
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div class="lg:col-span-2 space-y-6">
                            @include('BPMS::workflows.partials.basic-info')
                            @include('BPMS::workflows.partials.states')
                        </div>

                        <div class="space-y-6">
                            @include('BPMS::workflows.partials.preview')
                            @include('BPMS::workflows.partials.actions')
                        </div>
                    </div>
                </form>
            </div>
    ...
    @include('BPMS::workflows.partials.state-template')

    @vite('resources/js/pages/bpms-workflows.js')
</x-layouts.app>
