...
<div
    class="bg-bg-primary border border-border-light rounded-2xl p-6 hover:shadow-md hover:border-{{ $color }}-200 transition-all duration-200 relative overflow-hidden group">
