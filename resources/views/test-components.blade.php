<x-layouts.dashboard title="تست کامپوننت‌ها" current-page="dashboard">
    <div class="space-y-8">
        ...
        <section>
            ...
            <x-dashboard.quick-access :modules="[
        ...
        <section>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
                <x-ui.stat-mini icon="fa-file" iconColor="blue" value="۱,۲۴۸" label="فایل"/>
                <x-ui.stat-mini icon="fa-folder" iconColor="amber" value="۸۶" label="پوشه"/>
                <x-ui.stat-mini icon="fa-star" iconColor="yellow" value="۴۵" label="پسندیده"/>
                <x-ui.stat-mini icon="fa-hard-drive" iconColor="green" value="۱۲.۵" label="گیگابایت"/>
            </div>
        </section>
        ...
        <section>
            ...
            <div class="flex flex-wrap gap-4 items-end">
                <x-ui.avatar name="علی احمدی" size="sm"/>
                <x-ui.avatar name="محمد رضایی" size="md"/>
                <x-ui.avatar name="فاطمه محمدی" size="lg"/>
                <x-ui.avatar name="سارا قاسمی" size="xl"/>
            </div>
        </section>
        ...
        <section>
            ...
            <x-ui.storage-bar :used="12.5" :total="50" unit="GB"/>
        </section>

        <section>
            <h2 class="text-xl font-bold mb-4">ورودی OTP</h2>
            <x-ui.otp-input :length="4"/>
        </section>
        ...
        <section>
            ...
            <x-ui.data-table
                ...
                :rows="[
                    [
                        '<div class=\'flex items-center gap-2\'><x-ui.avatar name=\'علی احمدی\' size=\'sm\' /><span>علی احمدی</span></div>',
                        '09121234567',
                        'ali@example.com',
                    ...
                    [
                        '<div class=\'flex items-center gap-2\'><x-ui.avatar name=\'فاطمه محمدی\' size=\'sm\' /><span>فاطمه محمدی</span></div>',
                        '09129876543',
                        'fateme@example.com',
                        '<span class=\'inline-flex items-center gap-1.5 bg-green-50 text-green-700 px-2.5 py-1 rounded-lg text-xs font-medium\'>فعال</span>'
                    ]
        ...
        <section>
            ...
            <div class="max-w-md">
                <x-app.search-box placeholder="جستجو در تجربیات..." :withVoice="true"/>
            </div>
        </section>
        ...
        <section>
            ...
            <div class="mt-6">
                <x-ui.profile-image-upload name="profile_image" label="تصویر پروفایل" :standalone="true"/>
            </div>
        </section>
        ...
        <section>
            ...
            <x-Organization::permissions.role-header roleName="مدیر سیستم" usersCount="2" />
            ...
            <div class="space-y-6">
                @foreach($modules as $module)
                    <x-Organization::permissions.module-card :module="$module" :standard-permissions="$standardPermissions" />
                @endforeach
            </div>
        </section>
