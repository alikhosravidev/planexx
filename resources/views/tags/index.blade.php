@php
    ...
    $stats = [
        ['title' => 'کل برچسب‌ها', 'value' => 0, 'icon' => 'fa-solid fa-tags', 'color' => 'blue'],
        ['title' => 'موجودیت‌های برچسب زده', 'value' => 0, 'icon' => 'fa-solid fa-tag', 'color' => 'green'],
        ['title' => 'انواع موجودیت', 'value' => 0, 'icon' => 'fa-solid fa-database', 'color' => 'purple'],
        ...
        <main class="flex-1 flex flex-col">
            ...
            <div class="flex-1 p-6 lg:p-8">
                ...
                <form method="GET" action="{{ route('web.app.tags.index') }}" class="mb-6">
                    <x-ui.filter-bar :filters="$filters" :resetUrl="route('web.app.tags.index')" />
                </form>
