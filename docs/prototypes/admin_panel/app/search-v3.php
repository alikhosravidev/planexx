...
// پاسخ‌های نمونه AI (در پروژه واقعی از API)
$aiResponses = [
    'بهینه‌سازی' => 'بر اساس پایگاه دانش سازمانی ما، در زمینه بهینه‌سازی فرآیندها، سازمان تجربیات موفقی داشته است. به عنوان مثال، در بخش مالی با پیاده‌سازی اتوماسیون، زمان پردازش قراردادها ۴۰٪ کاهش یافته است. همچنین در بخش تولید، با بازطراحی خط تولید، بهره‌وری ۳۷٪ افزایش پیدا کرده است. توصیه می‌کنم ابتدا فرآیندهای فعلی را به دقت تحلیل کنید، گلوگاه‌ها را شناسایی کنید و سپس با استفاده از ابزارهای اتوماسیون مناسب، بهینه‌سازی را آغاز کنید.',
    'استخدام'    => 'در خصوص جذب و استخدام نیروی متخصص، تجربیات سازمان نشان می‌دهد که ایجاد شراکت با دانشگاه‌های برتر و برگزاری رویدادهای تخصصی مانند هکاتون‌ها، می‌تواند فرآیند استخدام را تا ۵۰٪ تسریع کند. همچنین پیاده‌سازی یک سیستم onboarding منظم و اختصاص منتور برای کارکنان جدید، رضایت شغلی را تا ۴۵٪ افزایش داده است. پیشنهاد می‌کنم یک برنامه جامع با چک‌لیست دیجیتال طراحی کنید و ارتباط نزدیکی با دانشگاه‌ها برقرار کنید.',
    'فناوری'     => 'در حوزه فناوری و اتوماسیون، سازمان ما تجربیات ارزشمندی دارد. پیاده‌سازی CI/CD باعث کاهش زمان deployment از ۲ ساعت به ۱۰ دقیقه شده است. همچنین استفاده از IoT در خط تولید، ضایعات را ۲۵٪ کاهش داده است. توصیه می‌کنم با یک پروژه پایلوت شروع کنید، نتایج را ارزیابی کنید و سپس به مرحله گسترش بروید. استفاده از ابزارهای مدرن مانند Docker و Jenkins می‌تواند تحول قابل توجهی ایجاد کند.',
    'default'    => 'با توجه به سوال شما و بررسی پایگاه دانش سازمانی، می‌توانم بگویم که سازمان ما در زمینه‌های مختلفی از جمله بهینه‌سازی فرآیندها، مدیریت منابع انسانی، فروش و بازاریابی دیجیتال، و فناوری‌های نوین تجربیات موفقی داشته است. لطفاً سوال خود را دقیق‌تر مطرح کنید تا بتوانم راهنمایی جامع‌تری ارائه دهم. من می‌توانم درباره استراتژی‌های خاص، چالش‌های پیش‌رو و راهکارهای عملی با شما صحبت کنم.',
];
...
<body class="bg-gradient-to-br from-slate-50 to-gray-100">
  ...
  <div class="max-w-[480px] mx-auto bg-white min-h-screen shadow-xl relative flex flex-col">
    ...
    <div class="bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 px-5 pt-6 pb-8">
      <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-white text-lg font-bold leading-tight">دستیار هوشمند</h1>
        ...
        <a href="/app/search-v2.php" class="w-9 h-9 bg-white/10 backdrop-blur-md rounded-lg flex items-center justify-center hover:bg-white/20 transition-all">
    ...
    <div class="flex-1 overflow-y-auto px-4 pt-4 pb-60 scroll-smooth" id="chatContainer">
      
      <!-- پیام خوش‌آمدگویی -->
      <div id="welcomeMessage" class="text-center py-12">
        <div class="w-20 h-20 mx-auto mb-5 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl flex items-center justify-center">
          <i class="fa-solid fa-brain text-3xl text-indigo-600"></i>
        </div>
        ...
        <p class="text-sm text-text-secondary leading-relaxed max-w-xs mx-auto">
          من می‌توانم پایگاه دانش سازمانی را برای شما جستجو کرده و بهترین پاسخ‌ها را ارائه دهم
        </p>
      </div>
        ...
        <div class="flex flex-col gap-2 p-4">
          ...
          <div class="flex-1">
            <textarea 
              ...
              style="min-height: 80px; max-height: 200px; overflow-y: auto;"></textarea>
          </div>
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-1">
              ...
              <button 
                id="attachBtn"
                class="w-9 h-9 flex items-center justify-center text-text-muted hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition-all duration-200"
                title="الصاق فایل">
            ...
            <button 
              id="sendBtn"
              class="w-9 h-9 flex items-center justify-center bg-gradient-to-br from-indigo-600 to-purple-600 text-white rounded-lg hover:shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              title="جستجو">
  ...
  <div id="experienceModal" class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 hidden">
    <div class="bg-white rounded-3xl shadow-2xl max-w-[460px] w-full max-h-[85vh] overflow-y-auto animate-slideUp">
      ...
      <!-- Header Modal -->
      <div class="sticky top-0 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 px-5 py-5 flex items-start justify-between gap-3 z-10">
        <div class="flex-1">
      ...
      <div class="p-5">
        ...
        <div class="grid grid-cols-2 gap-3">
          <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl p-3 text-center border border-indigo-100">
            <div class="text-xl font-bold text-indigo-600 mb-0.5" id="modalViews"></div>
            <div class="text-xs text-indigo-700">بازدید</div>
          </div>
          ...
          <div class="bg-gradient-to-br from-pink-50 to-rose-50 rounded-xl p-3 text-center border border-pink-100">
            <div class="text-xl font-bold text-pink-600 mb-0.5" id="modalDate"></div>
            <div class="text-xs text-pink-700">تاریخ</div>
          </div>
        </div>
  ...
  // پاسخ‌های AI (از PHP به JavaScript)
  const aiResponses = <?= json_encode($aiResponses, JSON_UNESCAPED_UNICODE) ?>;
  ...
  // متغیر برای جلوگیری از ارسال مکرر
  ...
  // اسکرول فوری به انتهای محتوا (برای حین تایپ)
  ...
  // اسکرول به انتهای محتوا با smooth behavior
  ...
  async function performSearch() {
    ...
    // شبیه‌سازی فرستادن به سرور و دریافت پاسخ AI
    ...
    // نمایش تجربیات مرتبط مستقیماً بدون باکس نتایج
  ...
  // شبیه‌سازی پاسخ AI با افکت تایپ
  async function simulateAIResponse(query) {
    // تشخیص نوع سوال
    let responseText = aiResponses.default;
    if (query.includes('بهینه') || query.includes('فرآیند')) {
      responseText = aiResponses['بهینه‌سازی'];
    } else if (query.includes('استخدام') || query.includes('جذب') || query.includes('منابع انسانی')) {
      responseText = aiResponses['استخدام'];
    } else if (query.includes('فناوری') || query.includes('اتوماسیون') || query.includes('تکنولوژی')) {
      responseText = aiResponses['فناوری'];
    }
    
    // ایجاد bubble پاسخ با لودینگ
    const aiMessageDiv = document.createElement('div');
    aiMessageDiv.className = 'flex justify-start mb-4';
    
    // ایجاد یک div برای محتوای تایپ
    const typingContentDiv = document.createElement('div');
    typingContentDiv.className = 'text-sm leading-relaxed text-text-primary';
    typingContentDiv.innerHTML = `
      <div class="flex items-center gap-2">
        ...
        <span class="text-xs text-text-muted">در حال تحلیل...</span>
      </div>
    `;
    
    aiMessageDiv.innerHTML = `
      <div class="max-w-[85%] bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-2xl rounded-bl-sm px-4 py-3">
        <div class="flex items-center gap-2 mb-3">
          <div class="w-6 h-6 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-full flex items-center justify-center">
    ...
    // اضافه کردن div محتوا به bubble
    aiMessageDiv.querySelector('.max-w-\\[85\\%\\]').appendChild(typingContentDiv);
    searchResults.appendChild(aiMessageDiv);
    
    // اسکرول بلافاصله بعد از اضافه کردن
    scrollToBottomInstant();
    
    // تاخیر شبیه‌سازی سرور
    await new Promise(resolve => setTimeout(resolve, 1500));
    
    // افکت تایپ - حالا از reference مستقیم استفاده می‌کنیم
    typingContentDiv.innerHTML = '';
    
    let currentIndex = 0;
    const typingSpeed = 20; // میلی‌ثانیه
    
    return new Promise((resolve) => {
      const typeChar = () => {
        if (currentIndex < responseText.length) {
          typingContentDiv.textContent += responseText[currentIndex];
          currentIndex++;
          
          // اسکرول بعد از هر کاراکتر
          scrollToBottomInstant();
          
          setTimeout(typeChar, typingSpeed);
        } else {
          // اسکرول نهایی بعد از اتمام تایپ با smooth
  ...
  function addUserMessage(message) {
    ...
    messageDiv.innerHTML = `
      <div class="max-w-[85%] bg-gradient-to-br from-indigo-600 to-purple-600 text-white rounded-2xl rounded-br-sm px-4 py-3 shadow-md">
