...
$prototypePages = [
  ...
  [
    'title' => 'داشبورد اصلی',
    'description' => 'داشبورد اصلی با دسترسی به تمام ماژول‌ها',
    'url' => '/dashboard/index.php',
    'icon' => 'fa-solid fa-chart-line',
    'badge' => 'داشبورد',
    'badge_color' => 'bg-slate-50 text-slate-700'
  ],
  [
    'title' => 'ماژول ساختار سازمانی',
    'description' => 'مدیریت کاربران، دپارتمان‌ها و موقعیت‌های شغلی',
  ...
  [
    'title' => 'ماژول پایگاه تجربه سازمانی',
    'description' => 'مدیریت تجربیات و قالب‌های تجربه سازمانی',
    'url' => '/dashboard/knowledge/index.php',
    'icon' => 'fa-solid fa-book',
    'badge' => 'تجربه',
    'badge_color' => 'bg-teal-50 text-teal-700'
  ],
  [
    'title' => 'لیست تجربیات',
    'description' => 'مشاهده، جستجو و فیلتر تجربیات سازمانی',
    'url' => '/dashboard/knowledge/experiences/list.php',
    'icon' => 'fa-solid fa-lightbulb',
    'badge' => 'تجربه',
    'badge_color' => 'bg-yellow-50 text-yellow-700'
  ],
  [
    'title' => 'ثبت تجربه جدید',
    'description' => 'فرم ثبت تجربه با قالب‌های سفارشی',
  ...
  [
    ...
    'description' => 'مدیریت و ایجاد قالب‌های تجربه',
    'url' => '/dashboard/knowledge/templates/list.php',
    'icon' => 'fa-solid fa-file-lines',
    'badge' => 'قالب',
    'badge_color' => 'bg-indigo-50 text-indigo-700'
  ],
  [
    'title' => 'افزودن قالب تجربه',
    'description' => 'فرم‌بیلدر برای ایجاد قالب‌های سفارشی',
    'url' => '/dashboard/knowledge/templates/create.php',
